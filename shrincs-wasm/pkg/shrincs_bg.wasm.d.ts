...
export const preparedStatelessKeyLen: (a: number) => number;
...
export const signStatelessPrepare: (a: number, b: number, c: number) => [number, number, number, number];
export const signStatelessWithPrepare: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
